...
Input  : LLM_results CSV/results_<run_id>.csv
Output : formatted/ordered/results_<run_id>_ordered.csv
"""
...
def main():
    ...
    parser.add_argument("--input_dir", default="LLM_results CSV")
    parser.add_argument("--output_dir", default="formatted/ordered")
