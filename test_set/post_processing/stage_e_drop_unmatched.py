...
def main():
    ...
    parser.add_argument("--input_dir", default="test_set/results/formatted/stage_abcd")
    parser.add_argument("--output_dir", default="test_set/results/formatted/stage_abcde")
